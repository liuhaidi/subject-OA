...
public class BaseTest {
	...
	private WebDriver newWebDriver(String driverType) throws IOException {
	 ...
	 if (driverType.equalsIgnoreCase("firefox")) {
		    String firefox_driver =ReadPro.getPropertyValue("gecko_driver");
			String firefox_path = ReadPro.getPropertyValue("firefox_path");
			...
			String chrome_path = ReadPro.getPropertyValue("chrome_path");
	...
	public void doBeforeSuite() throws Exception {
		...
		driverType=ReadPro.getPropertyValue("driverType");
